...
public class VM_BlockFinish extends AbstractVisitor {

	private static final Logger LOG = LoggerFactory.getLogger(VM_BlockFinish.class);
	...
	private static void fixSplitterBlock(BlockNode block) {
		...
		if (topSplitter == null) {
			LOGS.warn("Unknown top splitter block from list: {}", splitters);
			return;
		}
