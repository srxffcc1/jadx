...
@JadxVisitor(
		...
		runAfter = {VM_CodeShrinker.class, VM_ModVisitor.class}
)
public class VC_EnumVisitor extends AbstractVisitor {
	private static final Logger LOG = LoggerFactory.getLogger(VC_EnumVisitor.class);
	...
	public boolean visit(ClassNode cls) throws JadxException {
		...
		for (InsnNode putInsn : enumPutInsns) {
			...
			if (name != null
				...
				// LOGS.debug("Rename enum field: '{}' to '{}' in {}", fieldInfo.getName(), name, cls);
