...
public class VM_DotGraphVisitor extends AbstractVisitor {
	...
	private static final Logger LOG = LoggerFactory.getLogger(VM_DotGraphVisitor.class);
	...
	public static VM_DotGraphVisitor dump(File outDir) {
		return new VM_DotGraphVisitor(outDir, false, false);
	}

	public static VM_DotGraphVisitor dumpRaw(File outDir) {
		return new VM_DotGraphVisitor(outDir, false, true);
	}

	public static VM_DotGraphVisitor dumpRegions(File outDir) {
		return new VM_DotGraphVisitor(outDir, true, false);
	}

	public static VM_DotGraphVisitor dumpRawRegions(File outDir) {
		return new VM_DotGraphVisitor(outDir, true, true);
	}

	private VM_DotGraphVisitor(File outDir, boolean useRegions, boolean rawInsn) {
		this.dir = outDir;
