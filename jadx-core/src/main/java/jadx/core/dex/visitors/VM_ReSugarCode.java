...
@JadxVisitor(
		...
		runAfter = VM_CodeShrinker.class
)
public class VM_ReSugarCode extends AbstractVisitor {

	private static final Logger LOG = LoggerFactory.getLogger(VM_ReSugarCode.class);
