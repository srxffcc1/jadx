 ...
 * so this pass must be just before VC_CodeGen.
 */
@JadxVisitor(
		name = "VM_PrepareForCodeGen",
		desc = "Prepare instructions for code generation pass",
		runAfter = {VM_CodeShrinker.class, VC_ClassModifier.class}
)
public class VM_PrepareForCodeGen extends AbstractVisitor {
