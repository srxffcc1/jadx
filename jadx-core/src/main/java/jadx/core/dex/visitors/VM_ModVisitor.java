...
@JadxVisitor(
		...
		runBefore = VM_CodeShrinker.class
)
public class VM_ModVisitor extends AbstractVisitor {
	private static final Logger LOG = LoggerFactory.getLogger(VM_ModVisitor.class);
